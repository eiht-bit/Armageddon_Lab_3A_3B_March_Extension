...
resource "aws_ec2_transit_gateway_route" "kandagawa_route_to_sp01" {
  destination_cidr_block         = var.saopaulo_vpc_cidr
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.kandagawa_to_liberdade_peer01.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway.kandagawa_tgw01.association_default_route_table_id
}