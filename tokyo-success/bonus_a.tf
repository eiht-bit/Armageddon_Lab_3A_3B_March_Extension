...
locals {
  ...
  kandagawa_secret_arn_guess = "arn:aws:secretsmanager:${data.aws_region.kandagawa_region01.name}:${data.aws_caller_identity.kandagawa_self01.account_id}:secret:${local.name_prefix}/rds/mysqlk*"
}
